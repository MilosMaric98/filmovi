...
var movies = {
    'action': {
        ...
        'desc': [
                    'The Batman is a 2022 superhero film based on the DC Comics character Batman. Produced by Warner Bros. Pictures, DC Films, 6th & Idaho, and Dylan Clark Productions, and distributed by Warner Bros', 
                    'The Northman is a 2022 epic historical action drama film directed by Robert Eggers, and co-written by Eggers and Sjón. Based on the legend of Amleth, the film stars Alexander Skarsgård (who also produced), Nicole Kidman, Claes Bang, Anya Taylor-Joy, Ethan Hawke, Björk, and Willem Dafoe', 
        ...
        'imageUrl': [
                    './img/akcija/The_Batman.jpeg', 
                    './img/akcija/The_Northman.jpg', 
                    './img/akcija/Moon_Knight.jpeg', 
                    './img/akcija/Thor_Love_and_Thunder.jpeg', 
                    './img/akcija/Halo.jpeg', 
                    './img/akcija/Spider-Man_No_Way_Home.jpg', 
                    './img/akcija/Doctor_Strange_in_the_Multiverse_of_Madness.jpeg', 
                    './img/akcija/Ambulance.jpg', 
                    './img/akcija/No_Time_To_Die.jpeg'
                    ],
        'video': [
                    './video/akcija/the-batman.mov',
                    './video/akcija/the-northman.mov',
                    './video/akcija/moon-knight.mp4',
                    './video/akcija/thor-love-and-thunder.mov',
                    './video/akcija/halo.mp4',
                    './video/akcija/spider-man-no-way-home.mp4',
                    './video/akcija/Doctor Strange in the Multiverse of Madness.mp4',
                    './video/akcija/ambulance.mp4',
                    './video/akcija/no-time-to-die.mp4'
                 ]
    },
    'comedy': {
        'name': [
        ...
        'imageUrl': [
            './img/komedija/Bad_Grandpa.jpg', 
            './img/komedija/Worldsgreatestdad.jpg', 
            './img/komedija/Good_Boys.jpg',
            './img/komedija/Borat_2.jpg', 
            './img/komedija/21JumpStreetfilm.jpg', 
            './img/komedija/Neighbors.jpg', 
            './img/komedija/40-Year-OldVirgin.jpg', 
            './img/komedija/Barbershop.jpg', 
            './img/komedija/Adaptation.jpg'
        ],
        'video': [
            './video/komedija/bad-grandpa.mp4',
            './video/komedija/World’s- Greatest-Dad.mp4',
            './video/komedija/good-boys.mp4',
            './video/komedija/borat.mp4',
            './video/komedija/21js.mp4',
            './video/komedija/Neighbors.mp4',
            './video/komedija/40yov.mp4',
            './video/komedija/Barbershop.mp4',
            './video/komedija/adaptation.mp4'
        ]
    },
    'drama': {
        'name': [
        ...
        'imageUrl': [
            './img/drama/Right_stuff.jpg', 
            './img/drama/Vertigo.jpg', 
            './img/drama/Moonlight.jpg', 
            './img/drama/Gladiator.jpg', 
            './img/drama/The_Social_Network.jpg', 
            './img/drama/Schindlers_List.jpg', 
            './img/drama/Shattered_Glass.jpg', 
            './img/drama/Logan.jpg', 
            './img/drama/Dunkirk.jpg'
        ],
        'video': [
            './video/drama/the-right-stuff.mp4',
            './video/drama/vertigo.mp4',
            './video/drama/moonlight.mp4',
            './video/drama/gladiator.mp4',
            './video/drama/tsn.mp4',
            './video/drama/schindlers-list.mp4',
            './video/drama/sg.mp4',
            './video/drama/logan.mp4',
            './video/drama/dunkirk.mp4'
        ]
    },
    'sciFi': {
        'name': [
        ...
        'imageUrl': [
            './img/sciFi/Alien.jpg', 
            './img/sciFi/Blade_Runner.jpg', 
            './img/sciFi/Blade_Runner_2049.jpg', 
            './img/sciFi/2001_A_Space_Odyssey.jpg', 
            './img/sciFi/Her.jpg', 
            './img/sciFi/Ex-machina.jpg', 
            './img/sciFi/Dune.jpg', 
            './img/sciFi/Tenet.jpg', 
            './img/sciFi/Fifth_element.jpg'
        ],
        'video': [
            './video/sciFi/alien.mp4',
            './video/sciFi/blade-runner.mp4',
            './video/sciFi/blade-runner-2049.mp4',
            './video/sciFi/2001so.mp4',
            './video/sciFi/her.mp4',
            './video/sciFi/ex-machina.mp4',
            './video/sciFi/dune.mp4',
            './video/sciFi/tenet.mp4',
            './video/sciFi/tfe.mp4'
        ]
    },
};
var selectField = document.getElementById("zanr");
var selectedOption = selectField.options.selectedIndex;
var selectedValue = selectField.options[selectedOption].innerHTML;

/* prikazivanje filma po zanru na ekranu */

document.getElementById("zanr").onchange = function () {

    var selectField = document.getElementById("zanr");
    var selectedOption = selectField.options.selectedIndex;
    var selectedValue = selectField.options[selectedOption].innerHTML;
    
    if(selectedValue == "Akcija"){
        document.getElementById("movie_name1").innerHTML = movies.action.name[0];
        document.getElementById("img1").src = movies.action.imageUrl[0];
        document.getElementById("desc1").innerHTML = movies.action.desc[0];

        document.getElementById("movie_name2").innerHTML = movies.action.name[1];
        document.getElementById("img2").src = movies.action.imageUrl[1];
        document.getElementById("desc2").innerHTML = movies.action.desc[1];

        document.getElementById("movie_name3").innerHTML = movies.action.name[2];
        document.getElementById("img3").src = movies.action.imageUrl[2];
        document.getElementById("desc3").innerHTML = movies.action.desc[2];

        document.getElementById("movie_name4").innerHTML = movies.action.name[3];
        document.getElementById("img4").src = movies.action.imageUrl[3];
        document.getElementById("desc4").innerHTML = movies.action.desc[3];

        document.getElementById("movie_name5").innerHTML = movies.action.name[4];
        document.getElementById("img5").src = movies.action.imageUrl[4];
        document.getElementById("desc5").innerHTML = movies.action.desc[4];

        document.getElementById("movie_name6").innerHTML = movies.action.name[5];
        document.getElementById("img6").src = movies.action.imageUrl[5];
        document.getElementById("desc6").innerHTML = movies.action.desc[5];

        document.getElementById("movie_name7").innerHTML = movies.action.name[6];
        document.getElementById("img7").src = movies.action.imageUrl[6];
        document.getElementById("desc7").innerHTML = movies.action.desc[6];

        document.getElementById("movie_name8").innerHTML = movies.action.name[7];
        document.getElementById("img8").src = movies.action.imageUrl[7];
        document.getElementById("desc8").innerHTML = movies.action.desc[7];

        document.getElementById("movie_name9").innerHTML = movies.action.name[8];
        document.getElementById("img9").src = movies.action.imageUrl[8];
        document.getElementById("desc9").innerHTML = movies.action.desc[8];

    } else if(selectedValue == "Komedija"){
        document.getElementById("movie_name1").innerHTML = movies.comedy.name[0];
        document.getElementById("img1").src = movies.comedy.imageUrl[0];
        document.getElementById("desc1").innerHTML = movies.comedy.desc[0];

        document.getElementById("movie_name2").innerHTML = movies.comedy.name[1];
        document.getElementById("img2").src = movies.comedy.imageUrl[1];
        document.getElementById("desc2").innerHTML = movies.comedy.desc[1];

        document.getElementById("movie_name3").innerHTML = movies.comedy.name[2];
        document.getElementById("img3").src = movies.comedy.imageUrl[2];
        document.getElementById("desc3").innerHTML = movies.comedy.desc[2];

        document.getElementById("movie_name4").innerHTML = movies.comedy.name[3];
        document.getElementById("img4").src = movies.comedy.imageUrl[3];
        document.getElementById("desc4").innerHTML = movies.comedy.desc[3];

        document.getElementById("movie_name5").innerHTML = movies.comedy.name[4];
        document.getElementById("img5").src = movies.comedy.imageUrl[4];
        document.getElementById("desc5").innerHTML = movies.comedy.desc[4];

        document.getElementById("movie_name6").innerHTML = movies.comedy.name[5];
        document.getElementById("img6").src = movies.comedy.imageUrl[5];
        document.getElementById("desc6").innerHTML = movies.comedy.desc[5];

        document.getElementById("movie_name7").innerHTML = movies.comedy.name[6];
        document.getElementById("img7").src = movies.comedy.imageUrl[6];
        document.getElementById("desc7").innerHTML = movies.comedy.desc[6];

        document.getElementById("movie_name8").innerHTML = movies.comedy.name[7];
        document.getElementById("img8").src = movies.comedy.imageUrl[7];
        document.getElementById("desc8").innerHTML = movies.comedy.desc[7];

        document.getElementById("movie_name9").innerHTML = movies.comedy.name[8];
        document.getElementById("img9").src = movies.comedy.imageUrl[8];
        document.getElementById("desc9").innerHTML = movies.comedy.desc[8];

    } else if(selectedValue == "Drama"){
        document.getElementById("movie_name1").innerHTML = movies.drama.name[0];
        document.getElementById("img1").src = movies.drama.imageUrl[0];
        document.getElementById("desc1").innerHTML = movies.drama.desc[0];

        document.getElementById("movie_name2").innerHTML = movies.drama.name[1];
        document.getElementById("img2").src = movies.drama.imageUrl[1];
        document.getElementById("desc2").innerHTML = movies.drama.desc[1];

        document.getElementById("movie_name3").innerHTML = movies.drama.name[2];
        document.getElementById("img3").src = movies.drama.imageUrl[2];
        document.getElementById("desc3").innerHTML = movies.drama.desc[2];

        document.getElementById("movie_name4").innerHTML = movies.drama.name[3];
        document.getElementById("img4").src = movies.drama.imageUrl[3];
        document.getElementById("desc4").innerHTML = movies.drama.desc[3];

        document.getElementById("movie_name5").innerHTML = movies.drama.name[4];
        document.getElementById("img5").src = movies.drama.imageUrl[4];
        document.getElementById("desc5").innerHTML = movies.drama.desc[4];

        document.getElementById("movie_name6").innerHTML = movies.drama.name[5];
        document.getElementById("img6").src = movies.drama.imageUrl[5];
        document.getElementById("desc6").innerHTML = movies.drama.desc[5];

        document.getElementById("movie_name7").innerHTML = movies.drama.name[6];
        document.getElementById("img7").src = movies.drama.imageUrl[6];
        document.getElementById("desc7").innerHTML = movies.drama.desc[6];

        document.getElementById("movie_name8").innerHTML = movies.drama.name[7];
        document.getElementById("img8").src = movies.drama.imageUrl[7];
        document.getElementById("desc8").innerHTML = movies.drama.desc[7];

        document.getElementById("movie_name9").innerHTML = movies.drama.name[8];
        document.getElementById("img9").src = movies.drama.imageUrl[8];
        document.getElementById("desc9").innerHTML = movies.drama.desc[8];

    } else if(selectedValue == "Naučna fantastika"){
        document.getElementById("movie_name1").innerHTML = movies.sciFi.name[0];
        document.getElementById("img1").src = movies.sciFi.imageUrl[0];
        document.getElementById("desc1").innerHTML = movies.sciFi.desc[0];

        document.getElementById("movie_name2").innerHTML = movies.sciFi.name[1];
        document.getElementById("img2").src = movies.sciFi.imageUrl[1];
        document.getElementById("desc2").innerHTML = movies.sciFi.desc[1];

        document.getElementById("movie_name3").innerHTML = movies.sciFi.name[2];
        document.getElementById("img3").src = movies.sciFi.imageUrl[2];
        document.getElementById("desc3").innerHTML = movies.sciFi.desc[2];

        document.getElementById("movie_name4").innerHTML = movies.sciFi.name[3];
        document.getElementById("img4").src = movies.sciFi.imageUrl[3];
        document.getElementById("desc4").innerHTML = movies.sciFi.desc[3];

        document.getElementById("movie_name5").innerHTML = movies.sciFi.name[4];
        document.getElementById("img5").src = movies.sciFi.imageUrl[4];
        document.getElementById("desc5").innerHTML = movies.sciFi.desc[4];

        document.getElementById("movie_name6").innerHTML = movies.sciFi.name[5];
        document.getElementById("img6").src = movies.sciFi.imageUrl[5];
        document.getElementById("desc6").innerHTML = movies.sciFi.desc[5];

        document.getElementById("movie_name7").innerHTML = movies.sciFi.name[6];
        document.getElementById("img7").src = movies.sciFi.imageUrl[6];
        document.getElementById("desc7").innerHTML = movies.sciFi.desc[6];

        document.getElementById("movie_name8").innerHTML = movies.sciFi.name[7];
        document.getElementById("img8").src = movies.sciFi.imageUrl[7];
        document.getElementById("desc8").innerHTML = movies.sciFi.desc[7];

        document.getElementById("movie_name9").innerHTML = movies.sciFi.name[8];
        document.getElementById("img9").src = movies.sciFi.imageUrl[8];
        document.getElementById("desc9").innerHTML = movies.sciFi.desc[8];
    }
};
...
/* funkcije za prikaz filma na sledecoj strani */

function zapamti1(){
        for(var i=0; i<movies[selectField.value].name.length; i++){
            var ime = movies[selectField.value].name[0];
            var video = movies[selectField.value].video[0]
            sessionStorage.setItem("ime", ime);
            sessionStorage.setItem("desc", movies[selectField.value].desc[0]);
...
function zapamti2(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[1];
        var video = movies[selectField.value].video[1];
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[1]);
    }
}

function zapamti3(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[2];
        var video = movies[selectField.value].video[2];
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[2]);
    }
}

function zapamti4(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[3];
        var video = movies[selectField.value].video[3];
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[3]);
    }
}

function zapamti5(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[4];
        var video = movies[selectField.value].video[4];
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[4]);
    }
}

function zapamti6(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[5];
        var video = movies[selectField.value].video[5]
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("desc", movies[selectField.value].desc[5]);
        sessionStorage.setItem("ime", ime);
    }
}
...
function zapamti7(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[6];
        var video = movies[selectField.value].video[6]
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[6]);
    }
}

function zapamti8(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[7];
        var video = movies[selectField.value].video[7]
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[7]);
    }
}

function zapamti9(){
    for(var i=0; i<movies[selectField.value].name.length; i++){
        var ime = movies[selectField.value].name[8];
        var video = movies[selectField.value].video[8]
        sessionStorage.setItem("video", video);
        sessionStorage.setItem("ime", ime);
        sessionStorage.setItem("desc", movies[selectField.value].desc[8]);
    }
}